					...
					<tbody>
						<c:forEach items="${depart}" var="p">
							...
							<tr>
								...
								<td><c:if test="${p.active==false}">

										<span class="custom-badge status-red">Inactive</span>

									</c:if> <c:if test="${p.active==true}">

										<span class="custom-badge status-green">Active</span>

									</c:if></td>
								<td><a href="deletedepartment?id=${p.departmentId}">DELETE</a>|

									<a href="Editdepartment?id=${p.departmentId}">Edit</a></td>
