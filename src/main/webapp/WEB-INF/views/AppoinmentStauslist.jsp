		...
		<div class="page-wrapper">
			<div class="content">
				...
				<div class="col-sm-14 col-18 text-right m-b-90">
					<a href="appoimentstatus"
						class="btn btn-primary btn-rounded float-right"><i
						class="fa fa-plus"></i> Add AppoinmentStatus</a>
				</div>
				...
				<table border="4" id="listtable"
					class="table table-striped table-hover" class="center">
					<thead>
						<tr>
					...
					<c:forEach items="${apstatus}" var="p">
						...
						<tbody>
							...
							<tr>
								...
								<td>${p.statusName }</td>
								<td><a
									href="deleteappoinmentstatus?id=${p.appoinmentStatusId}">DELETE</a></td>
