		...
		<div class="page-wrapper">
			<div class="content">
				...
				<div class="col-sm-14 col-18 text-right m-b-90">
					<a href="ratetype" class="btn btn-primary btn-rounded float-right"><i
						class="fa fa-plus"></i> Add RateType</a>
				</div>
					...
					<tbody>
						...
						<c:forEach items="${ratetype}" var="p">
							...
							<tr>
								<td>${p.ratetypeId }</td>
								<td>${p.type }</td>
								<td><a href="deleteratetype?id=${p.ratetypeId}">DELETE</a>
									| <a href="Editratetype?id=${p.ratetypeId}">Edit</a></td>
