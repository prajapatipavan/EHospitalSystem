	...
	<div class="main-wrapper">
		...
		<div class="page-wrapper">
			<div class="content">
				<h4>Appointments</h4>
				<div
					style="border: 0.3px solid rgb(128, 127, 127); padding: 20px; box-shadow: 10px 10px 5px #ededed;">
					<table border="3" id="listtable"
						class="table table-striped table-hover tab">
						<thead>
							<tr>
								<td>AppoinmentId</td>
								<td>Doctor Name</td>
                             ...
                             <td>${p.firstName1} ${p.lastName}</td>
								...
								<td>${p.createdDate}</td>
									...
									<td><a href="viewpatientopd?id=${p.patientId}"
										style="border-bottom: 1px solid red;">OPD</a> | <a href=""
										style="border-bottom: 1px solid red;">OPT</a> | <a href=""
										style="border-bottom: 1px solid red;">DOCTOR</a><br> <a
										href="" style="border-bottom: 1px solid red;">counseling</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
